...
List<Receitas> findByDescricao(String descricao);
	...
	@Query(value = "select obj FROM db_controle_financeiro.Receitas obj LEFT JOIN FETCH obj.despesas")
	List<Receitas> getReceitas(Pageable pageable);
	
	@Query(value = "select obj FROM db_controle_financeiro.Receitas obj LEFT JOIN FETCH obj.despesas WHERE obj.descricao like %:descricao%")
	...
	@Query(value = "select obj FROM db_controle_financeiro.Receitas obj LEFT JOIN FETCH obj.despesas WHERE obj.id = :id")
